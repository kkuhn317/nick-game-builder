package builderManager
{
   ...
   public class ToolManager extends EventDispatcher
   {
      ...
      private var editorPreview:Bitmap;
      public function init() : void
      {
         if(BuilderMain.instance.editorPrototype)
         {
            this.mcContainer=new MovieClip();
            this.editorPreview=new Bitmap(); this.editorPreview.alpha=0.55;
            this.mcContainer.addChild(this.editorPreview);
            this.mcContainer.mouseEnabled=false; this.mcContainer.mouseChildren=false;
            BuilderMain.instance.addChild(this.mcContainer);
            this.nCurrentTool=TOOL_NONE; this.nLastTime=getTimer();
            ...
            this.stopDrag(); return;
         }
         var toolsClass:Class=getDefinitionByName("mcTools") as Class;
         this.mcContainer = new toolsClass();
      ...
      {
         if(this.editorPreview != null)
         {
            if(this.mcContainer.parent != null) this.mcContainer.parent.removeChild(this.mcContainer);
            this.editorPreview.bitmapData=null; this.editorPreview=null;
         }
      ...
      private function updateDraggedBD() : void
      {
         ...
         if(this.editorPreview != null) this.editorPreview.bitmapData=_oBD;
         if(Boolean(this.oCursor))
         {
      ...
      {
         if(BuilderMain.instance.editorPrototype) return null;
      ...
      private function onUpdate(_e:UpdateEvent) : void
      {
         ...
         if(BuilderMain.instance.editorPrototype || StepManager.instance.currentStepNumber == nBUILDER_STEP)
         {
            ...
            if(BuilderMain.instance.editorPrototype || (!_oConfirmPopup.isDisplayed && !_oSavePopup.isDisplayed))
            {
               this.updateMousePos();
               this.updateTilePos();
         ...
         if(this.editorPreview != null)
         {
            this.editorPreview.visible=this.oRenderPos != null;
            if(this.oRenderPos != null)
            {
               var p:Point=this.oRenderer.mcContainer.localToGlobal(new Point(this.oRenderer.mcContainer.width/2+this.oRenderPos.x,this.oRenderer.mcContainer.height/2+this.oRenderPos.y));
               p=this.mcContainer.globalToLocal(p); this.editorPreview.x=p.x; this.editorPreview.y=p.y;
            }
         }
         this.nLastTime = getTimer();
      }
      public function editorZoom() : void { this.onBtnZoom(null); }

package
{
   ...
   public class BuilderMain extends AbstractApplication
   {
      ...
      private function diagnosticInit() : void
      {
         ...
         diagnosticLog("DIAGNOSTIC BUILD v3 - replacement loading view; original dependency checks. F2 toggles log.");
      ...
      {
         diagnosticLog("ENTER onExternalConfigLoaded");
         eventManager.cleanUp(sEVENT_PRELOAD_ID);
         this.initGameData();
      ...
      {
         diagnosticLog("ENTER onPropertyConfigLoaded");

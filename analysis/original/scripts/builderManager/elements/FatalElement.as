package builderManager.elements
{
   ...
   public class FatalElement extends BuilderElement
   {
      
      private var sLinkage:String;
      
      public function FatalElement(_nX:Number, _nY:Number, _oMedia:AbstractMedia, _bFlip:Boolean)
      {

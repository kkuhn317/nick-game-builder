package media.type
{
   ...
   public class TileFatalMedia extends AbstractTileMedia
   {
      
      public static const TYPE:String = "tileFatal";
      
      private static const GAME_LINKAGES:Array = ["mcPlatform_tile00","mcPlatform_tile01","mcPlatform_tile02","mcPlatform_tile03","mcPlatform_tile04","mcPlatform_tile05","mcPlatform_tile06","mcPlatform_tile07","mcPlatform_tile08","mcPlatform_tile09","mcPlatform_tile10","mcPlatform_tile11","mcPlatform_tile12","mcPlatform_tile13","mcPlatform_tile14","mcPlatform_tile15"];
      
      private static const PREVIEW_LINKAGES:Array = ["mcPlatform_tile03"];
      
      public function TileFatalMedia(_sAlias:String, _sMediaDirectory:String)
      {

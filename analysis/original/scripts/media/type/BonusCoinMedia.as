package media.type
{
   public class BonusCoinMedia extends AbstractMedia
   {
      
      public static const TYPE:String = "bonusCoin";
      ...
      public function BonusCoinMedia(_sAlias:String, _sMediaDirectory:String)
      {

package media.type
{
   public class BonusExtraLifeMedia extends AbstractMedia
   {
      
      public static const TYPE:String = "bonusExtraLife";
      ...
      public function BonusExtraLifeMedia(_sAlias:String, _sMediaDirectory:String)
      {

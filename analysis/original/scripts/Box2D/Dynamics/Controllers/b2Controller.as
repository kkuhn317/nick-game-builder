package Box2D.Dynamics.Controllers
{
   ...
   public class b2Controller
   {
      ...
      public function AddBody(body:b2Body) : void
      {
         ...
         if(Boolean(edge.nextController))
         {
      ...
      public function RemoveBody(body:b2Body) : void
      {
         ...
         while(Boolean(edge) && edge.controller != this)
         {
            edge = edge.nextController;
         }
         if(Boolean(edge.prevBody))
         {
         ...
         if(Boolean(edge.prevController))
         {

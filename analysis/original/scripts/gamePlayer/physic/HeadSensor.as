package gamePlayer.physic
{
   ...
   public class HeadSensor implements IContactManaged
   {
      ...
      public function HeadSensor(_oColliderRect:Rectangle, _oParentBody:b2Body)
      {
         super();
      ...
      private function initBody(_oColliderRect:Rectangle) : void
      {
         ...
         _oSensorShape.SetAsOrientedBox(_nRadius - 12 / CommonConfig.nCELL_SIZE,_oColliderRect.height / 2 - 15 / CommonConfig.nCELL_SIZE,new b2Vec2(0,-(_oColliderRect.height / 2 + 0.75)));
      ...
      public function isTouchingCeiling() : Boolean
      {
         var _isTouchingCeiling:Boolean = false;
         if(this.isCollidingWithSurface(SurfaceType.CEILING,SurfaceType.FATAL_CEILING))
         {
